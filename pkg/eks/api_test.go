...
var _ = Describe("eksctl API", func() {
	...
	Context("loading config files", func() {
		...
		It("shuold error when version is a float, not a string", func() {
		...
		It("shuold reject unknown field in a YAML config", func() {
		...
		It("shuold reject unknown field in a JSON config", func() {
		...
		It("shuold reject old API version", func() {
		...
		It("shuold error when cannot read a file", func() {
